...
sub-interfaces like Set and List.

Collection Framework defines several classes and interfaces to represent a group of objects as a single unit. Collections
are used to store, retrieve, manipulate and communicate aggregated [formed by the combination of several separate elements]
data.
...
<tr><td>5) We can make the HashMap as synchronized by calling this code<br> Map m = Collections.synchronizedMap(hashMap);</td><td>Hashtable is internally synchronized and can't be un-synchronized.</td></tr>
...
<table class="alt">
<tbody>
<tr><th></th><th>Synchronized</th><th>Locking</th><th>No of Threads</th><th>Null</th><th>Iterator</th><th>When to Use</th></tr>
<tr><td>HashMap</td><td>No</td><td>No Lock</td><td>Multiple Threads</td><td>One null key & N no. of null values</td><td>Fail Fast</td><td>Single Threaded environment</td></tr>
<tr><td>Hashtable</td><td>All operations are synchronized</td><td>Object level Lock</td><td>One Thread</td><td>Does not allow null key null values</td><td>Fail Safe</td><td>Legacy class & Not recommended to use</td></tr>
<tr><td>SynchronizedHashMap</td><td>All operations are synchronized</td><td>Object level Lock</td><td>One Thread</td><td>One null key & N no. of null values</td><td>Fail Fast</td><td>Multi-Threaded environment</td></tr>
...
versions of Java and has now been restructured or re-engineered. They are fully compatible with the framework.
